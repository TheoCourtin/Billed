...
// Connecté en tant qu'admin, sur la page Dashboard, il y a des factures en attente 
// Quand je clique sur une facture en attente, je vois des factures
describe('Given I am connected as an Admin', () => {
  ...
  // Connecté en tant qu'admin, sur la page Dashboard, il y a des factures en "accepté" 
  // Quand je clique sur une facture en "accepté", je vois des factures
  ...
  // Connecté en tant qu'admin, sur la page Dashboard, il y a des factures en "refusé" 
  // Quand je clique sur une facture en "refusé", je vois des factures
  ...
  // Connecté en tant qu'admin, j'arrive sur la Dashboard, le contenu est chargé
  ...
  // Connecté en tant qu'admin, j'arrive sur la Dashboard, le back-end peut envoyer un message d'erreur
  ...
  // Connecté en tant qu'admin, je clique sur le bouton déplier la liste des billets devrait se dérouler et les cartes devraient apparaître
  ...
  // Connecté en tant qu'admin, quand je clique sur une facture, le détail de cette facture s'affiche
  ...
  // Connecté en tant qu'admin, si il n'y a pas de factures sur la page Dashboard alors aucunes factures n'apparaient
...
// Connecté en tant d'admin, sur la Dashboard je clique sur une facture en attente et je l'accepte
// La facture est dans acceptée et je suis renvoyer sur la dashboard 
describe('Given I am connected as Admin, and I am on Dashboard page, and I clicked on a pending bill', () => {
  ...
  // Connecté en tant d'admin, sur la Dashboard je clique sur une facture en attente et je la refuse
  // La facture est dans refusée et je suis renvoyer sur la dashboard 
...
// Connecté en tant d'admin, sur la Dashboard je clique sur une facture en attente et je clique sur l'oei de la partie justificatif 
// Je vois la modale s'ouvrir avec l'image 
